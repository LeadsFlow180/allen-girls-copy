...
import { LeaderboardHub } from "@/components/learn/leaderboard-hub";
...
export default function LearnLeaderboardPage() {
  ...
  return (
    <LearnPageFrame activeTab="leaderboards">
      <div
        style={{
          maxWidth: "900px",
          margin: "0 auto",
      ...
      >
        ...
        >
          ...
          <LearnStatsBar onStreakViewMore={() => router.push("/learn/quests")} />
        </header>
